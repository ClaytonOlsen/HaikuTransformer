...
Built using just the decoder part of the model described in <a href=”[Attention is All You Need](https://arxiv.org/abs/1706.03762)”>"Attention is All You Need"</a>. The model structure is shown below
